    ...
    <main className="h-full bg-dark">
      <div className="w-[90%] mx-auto py-20">
        ...
        <div className="flex items-center justify-center h-full">
          ...
          <div className="relative hidden lg:block" onClick={handleClick}>
            <MeetupMap />
            <div
              className="absolute top-[305px] left-[760px] p-2 -ml-2 -mt-2 cursor-pointer"
              ref={reference}
